...
<body>
    ...
    <!-- <div class="container"> -->
        <h1 class="text-warning text-center">Patient Request</h1>
        ...
        <?php
                ...
                <tr class="text-center">
                    ...
                    <!-- <td><button class="btn-primary btn"><div class="text-white"> Pending...</div></button> -->
                    <!-- <button class="btn-danger btn"><a href="donordelete.php?id=<?php echo $res['id']; ?>" class="text-white"> Reject</a></button></td> -->
