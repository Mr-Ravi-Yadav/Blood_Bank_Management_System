...
<body>
    ...
    <script>
        function Project()
        {
            ...
            //     }
            // if(isNan(Mobile)){
            //     document.getElementById('b').innerHTML="Enter Only Numeric Value ";
            //     return false;
            //     }
            // if(Mobile.length<10){
            //     document.getElementById('b').innerHTML="Mobile No. must be 10 digit";
            //     return false;
            //     }
            // if(Mobile.length<10){
            //     document.getElementById('b').innerHTML="Mobile No. must be 10 digit ";
            ...
            //     document.getElementById('b').innerHTML="Mobile No. must start with 9, 8, 7 ";
            //     return false;
            //     }
    ...
    <div class="container">
        ...
        <form action="connection1.php" method="POST" onsubmit="return Project()">
            <label for="firstname"><b>First Name</b></label>
            <input type="text" id="firstname" value="" name="firstname" max="10" min="3" class="input-box" placeholder="Your first name.." required>
            ...
            <input type="text" id="email" value="" name="Email" class="input-box" placeholder="Email" required>
            ...
            <input type="date" name="date" id="date" name="date" value="" min="2000-01-01" max="2021-09-20" required>
            <span id="dat"></span><br><br> -->
